...
const Hero = () => {
  return (
    ...
    bg-[url(/gradientBackground.png)] bg-cover bg-no-repeat min-h-screen">
      ...
      <div className="text-center mb-6">
        ...
        <p className="mt-4 max-w-xs sm:max-w-lg 2xlg:max-w-xl m-auto max-sm:text-xs text-gray-600">
  ...
  <button
    onClick={() => navigate('/ai')}
    className="bg-blue-600 text-white px-10 py-3 rounded-lg hover:scale-102 active:scale-95 transition cursor-pointer">
    Start creating now
  </button>
